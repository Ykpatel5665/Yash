...
class PlayerListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final double contentPaddingH = (MediaQuery.of(context).size.width * 0.06).clamp(12, 28); // Match category tile horizontal padding
    final double tileRadius = 14;
    return Container(
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.10), // Slightly more visible tile background
